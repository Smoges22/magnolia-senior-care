window.AFHSite = {
  ...
  locations: {
    burien: {
      name: "Magnolia Senior Loving Care LLC",
      displayName: "Magnolia Senior Loving Care",
      city: "Burien",
      state: "WA",
      zip: "98166",
    ...
    highline: {
      name: "Magnolia Senior Care of Highline LLC",
      displayName: "Magnolia Senior Care of Highline",
      city: "Des Moines",
      state: "WA",
      zip: "98198",
  ...
  testimonials: [
    {
      quote: "Magnolia's RN-led approach gave us confidence during a difficult transition. The home felt warm, calm, and personal.",
      name: "Family member"
    },
    {
    ...
    {
      quote: "The communication was professional and human. We understood the next steps and felt respected throughout.",
